    ...
    <section class="clean-block clean-form dark">
        ...
        &nbsp
            <div class="block-heading">
                <h2 class="text-info" style="color: var(--bs-blue);border-top-color: rgb(13,114,253);border-bottom-color: rgba(59,153,224,0);">Registrar Cobro de Mantenimiento por Carro</h2>
            </div>
            ...
            <form action="/registro.php" method="POST" class="w-auto p-3" style="color: rgb(0,15,255);background: rgba(13,114,255,0.11);border-top-color: rgb(13,114,255);">
                ...
                <div class="mb-3">
                    <label class="form-label" for="costo_det">Costo total del Mantenimiento</label>
