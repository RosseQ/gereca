    ...
    <section class="clean-block clean-form dark" style="background: url(&quot;assets/img/clipboard-image-1.png&quot;);">
        <div class="container">
            ...
            <form action="/registro.php" method="POST" style="color: rgb(255,15,0);background: rgba(253,114,13,0.11);border-top-color: rgb(253,114,13);">
                ...
                <div class="mb-3"><label class="form-label" for="username_h">Trabajador</label>
                    <select class="form-select" id="username_h" name="username_h">
                        <?php 
                        ...
                        ?>
                            <option id="username_h" name="username_h" value="<?php echo $mostrar['username'] ?>" selected><?php echo $mostrar['nombres'] ?></option>
                        <?php }?>
                    </select>
                </div>
