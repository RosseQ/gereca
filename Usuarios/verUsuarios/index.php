                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th style="background: rgb(253,114,13);">Id ingreso</th>
                            <th style="background: rgb(253,114,13);">Economico</th>
                            <th style="background: rgb(253,114,13);">Tipo de renta</th>
                            <th style="background: rgb(253,114,13);">Dias</th>
                            <th style="background: rgb(253,114,13);">Tarifa</th>
                            <th style="background: rgb(253,114,13);">Costo de mantenimiento</th>
                            <th style="background: rgb(253,114,13);">total neto</th>
                            <th style="background: rgb(253,114,13);">fecha de ingreso</th>
                        </tr>
                    </thead>
                        <?php 
